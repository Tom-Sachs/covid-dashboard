...
def annotate_barh(axs, space=7):
  ...
  ''' Only works with horizontal bar plots.
  Add data labels at the end of each bar.

  space parameter represents the distance (number of points)
  between the bar and the label, and can be changed.
  ...
  for rect in rects:
      ...
      axs.annotate(
          ...
          ha=ha,
          clip_on=True)                      # Horizontally align label differently for
